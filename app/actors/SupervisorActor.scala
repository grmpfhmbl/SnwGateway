...
@deprecated case class DbActorCommand(fieldid: Int, value: String)
@deprecated case class TaromActorCommand(fieldid: Int, value: String)
@deprecated case class SpaActorCommand(fieldid: Int, value: String)
@deprecated case class XBeeActorCommand(fieldid: Int, value: String)
@deprecated case class SosActorCommand(fieldid: Int, value: String)
